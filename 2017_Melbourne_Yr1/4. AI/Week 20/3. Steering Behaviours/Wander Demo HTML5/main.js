...
game.textures.backgrounds.grass = loadImage("./grass.png");
game.textures.bullet = loadImage("./bullet.png");
game.textures.splat = loadImage("./bloodsplat.png");
...
game.sprites.zombie = new Sprite("./zombie.png");
